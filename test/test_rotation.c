...
*   60 (B)     ADD    60 (B)                   60 (b)                     
*    / \       80     / \                      / \
*     100(B)   -->     100(B)      Recolor  null  100(R)      
*      / \               / \         ---->       /  \        
...
*
*      150              150       leftRight            50
*      / \             / \      --------->           /  \
*    20 250          20 250                        20   150  
*    / \    ADD     / \                           / \   / \
*   5  50    25    5  50                         5  25 100 250
*     / \             / \
*       100         25 100
*/
void xtest_left_right_rotation_with_node_one_hundred_and_fifty_and_child_twenty(void){
  ...
  initNode(&node50, 50, &node25, &node100, BLACK);
  initNode(&node100, 100, NULL, NULL, BLACK);
  initNode(&node25, 25, &node250, NULL, RED); 
  initNode(&node5, 5, NULL, NULL, BLACK);  
  rbtAdd(&rootPtr, addNode);
